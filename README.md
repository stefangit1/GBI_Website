...
- Free nice-to-have tools like Interest or Position Calculators
- and even more information in FAQs and Community pages.

## Features
- Secure Login/Register and Password Reset functions
- Customizable User profiles
- Full Administrator dashboard (not included in GitHub) for User and Content Management
- MariaDB Database for storing information and uploading new content
